...
final class CreateMeetingVC: UIViewController {
    ...
    private var selectedPhoto: CreateMeetingPhotoUpload?
    ...
    private func handleSelectedImageData(_ data: Data) {
        ...
        selectedPhoto = CreateMeetingPhotoUpload(
            data: uploadData,
...
extension CreateMeetingVC: PHPickerViewControllerDelegate {
...
extension CreateMeetingVC: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
